...
function PlanCard({
    ...
    return (
        <div
            className={[
                "relative overflow-hidden rounded-2xl border bg-[#0B1220]/90 p-6 shadow-[0_28px_64px_rgba(2,6,23,0.7)] backdrop-blur-xl sm:p-7",
        ...
        >
            ...
            <div className="relative flex h-full flex-col text-center">
                <div className="mb-4 flex flex-wrap items-center justify-center gap-2">
                    ...
                    {badge ? (
                        <span className="rounded-full border border-emerald-400/30 bg-emerald-500/15 px-3.5 py-1 text-[11px] font-bold uppercase tracking-[0.14em] text-emerald-200">
                            {badge}
                        </span>
                    ) : null}
                </div>
    ...
    return (
        ...
        >
            ...
            <motion.div className="relative mx-auto max-w-6xl px-6 sm:px-8" {...reveal}>
                ...
                <div className="relative grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-7 lg:gap-8">
                    <div
                        className={[
                    ...
                    <PlanCard
                        ...
                        tagline={t.pricingTradingOnlyTagline}
                    ...
                    <PlanCard
                        ...
                        badge={t.pricingFullProgramBadge}
                        tagline={t.pricingFullProgramTagline}
