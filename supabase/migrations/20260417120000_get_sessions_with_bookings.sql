-- Admin RPC: sessions with current booking totals.
-- Returns canonical columns expected by admin dashboard:
-- id (uuid), date (date), time (text), capacity (int), booked (int)
