...
export default function AdminLoginPage() {
    ...
    const queryError = useMemo(() => {
        const value = searchParams.get("error")?.trim()
        if (!value) return null
        if (value === "unauthorized") return "Only authorized corporate admin accounts can access this area."
        if (value === "session_expired") return "Your admin session expired. Request a new secure login link."
