...
export async function GET() {
    try {
        ...
        const { data, error } = await supabase
            ...
            .select(
                "id, email, first_name, last_name, phone, plan, profile_completed, access_type, is_active, access_expires_at, access_code, created_at, subscription_id, subscription_status"
            )
